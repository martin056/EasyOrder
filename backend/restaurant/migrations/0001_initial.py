# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2018-01-27 13:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='menu_sections', to='restaurant.Menu')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('panding', 'pending'), ('voided', 'voided'), ('paid', 'paid')], default='panding', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
            fields=[
                ...
                ('item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='restaurant.Item')),
        ...
        migrations.AddField(
            model_name='table',
            name='waiter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tables', to='restaurant.Waiter'),
        ),
        migrations.AddField(
            model_name='order',
            name='items',
        ...
        migrations.AddField(
            model_name='item',
            name='menu_section',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='restaurant.MenuSection'),
        ),
    ]
